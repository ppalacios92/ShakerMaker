 ...
 * Generation date: Sun Feb  1 01:19:41 2026
...
/*decl*/
    ...
    PyArrayObject *capi_tdata_tmp = NULL;
...
/*frompyobj*/
    ...
    if (capi_d_tmp == NULL) {
        ...
        PyErr_SetString(exc ? exc : core_error,"failed in converting 6th argument `d' of core.subgreen to C/Fortran array" );
    ...
    if (capi_a_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : core_error,"failed in converting 7th argument `a' of core.subgreen to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
    ...
    if (capi_b_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : core_error,"failed in converting 8th argument `b' of core.subgreen to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
    ...
    if (capi_rho_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : core_error,"failed in converting 9th argument `rho' of core.subgreen to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
    ...
    capi_qa_tmp = array_from_pyobj(NPY_FLOAT,qa_Dims,qa_Rank,capi_qa_intent,qa_capi);
    if (capi_qa_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : core_error,"failed in converting 10th argument `qa' of core.subgreen to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        qa = (float *)(PyArray_DATA(capi_qa_tmp));

    /* Processing variable qb */
    qb_Dims[0]=mb;
    capi_qb_intent |= F2PY_INTENT_IN;
    capi_qb_tmp = array_from_pyobj(NPY_FLOAT,qb_Dims,qb_Rank,capi_qb_intent,qb_capi);
    if (capi_qb_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : core_error,"failed in converting 11st argument `qb' of core.subgreen to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        qb = (float *)(PyArray_DATA(capi_qb_tmp));
    ...
    if (capi_x_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : core_error,"failed in converting 25th argument `x' of core.subgreen to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
    ...
    capi_tdata_tmp = array_from_pyobj(NPY_FLOAT,tdata_Dims,tdata_Rank,capi_tdata_intent,Py_None);
    if (capi_tdata_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : core_error,"failed in converting hidden `tdata' of core.subgreen to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        tdata = (float *)(PyArray_DATA(capi_tdata_tmp));

    /* Processing variable zz */
    zz_Dims[0]=2 * nfft;
    capi_zz_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
    capi_zz_tmp = array_from_pyobj(NPY_FLOAT,zz_Dims,zz_Rank,capi_zz_intent,Py_None);
    if (capi_zz_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : core_error,"failed in converting hidden `zz' of core.subgreen to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
    ...
    capi_ee_tmp = array_from_pyobj(NPY_FLOAT,ee_Dims,ee_Rank,capi_ee_intent,Py_None);
    if (capi_ee_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : core_error,"failed in converting hidden `ee' of core.subgreen to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        ee = (float *)(PyArray_DATA(capi_ee_tmp));

    /* Processing variable nn */
    nn_Dims[0]=2 * nfft;
    capi_nn_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
    capi_nn_tmp = array_from_pyobj(NPY_FLOAT,nn_Dims,nn_Rank,capi_nn_intent,Py_None);
    if (capi_nn_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : core_error,"failed in converting hidden `nn' of core.subgreen to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        nn = (float *)(PyArray_DATA(capi_nn_tmp));

    /* Processing variable t0 */
    t0_Dims[0]=nx;
    capi_t0_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
    capi_t0_tmp = array_from_pyobj(NPY_FLOAT,t0_Dims,t0_Rank,capi_t0_intent,Py_None);
    if (capi_t0_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : core_error,"failed in converting hidden `t0' of core.subgreen to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        t0 = (float *)(PyArray_DATA(capi_t0_tmp));
...
/*end of pyobjfrom*/
        ...
        capi_buildvalue = Py_BuildValue("NNNNN",capi_tdata_tmp,capi_zz_tmp,capi_ee_tmp,capi_nn_tmp,capi_t0_tmp);
/*closepyobjfrom*/
...
/*cleanupfrompyobj*/
    ...
    }  /*if (capi_tdata_tmp == NULL) ... else of tdata*/
    /* End of cleaning variable tdata */
    if((PyObject *)capi_x_tmp!=x_capi) {
        Py_XDECREF(capi_x_tmp); }
    }  /*if (capi_x_tmp == NULL) ... else of x*/
    /* End of cleaning variable x */
    if((PyObject *)capi_qb_tmp!=qb_capi) {
        Py_XDECREF(capi_qb_tmp); }
    }  /*if (capi_qb_tmp == NULL) ... else of qb*/
    /* End of cleaning variable qb */
    if((PyObject *)capi_qa_tmp!=qa_capi) {
        Py_XDECREF(capi_qa_tmp); }
    }  /*if (capi_qa_tmp == NULL) ... else of qa*/
...
/*frompyobj*/
    ...
    if (capi_d_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : core_error,"failed in converting 6th argument `d' of core.subgreen2 to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        d = (float *)(PyArray_DATA(capi_d_tmp));
    ...
    if (capi_a_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : core_error,"failed in converting 7th argument `a' of core.subgreen2 to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        a = (float *)(PyArray_DATA(capi_a_tmp));
    ...
    if (capi_b_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : core_error,"failed in converting 8th argument `b' of core.subgreen2 to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        b = (float *)(PyArray_DATA(capi_b_tmp));
    ...
    if (capi_rho_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : core_error,"failed in converting 9th argument `rho' of core.subgreen2 to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        rho = (float *)(PyArray_DATA(capi_rho_tmp));
    ...
    if (capi_qa_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : core_error,"failed in converting 10th argument `qa' of core.subgreen2 to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        qa = (float *)(PyArray_DATA(capi_qa_tmp));
    ...
    if (capi_qb_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : core_error,"failed in converting 11st argument `qb' of core.subgreen2 to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        qb = (float *)(PyArray_DATA(capi_qb_tmp));
    ...
    if (capi_x_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : core_error,"failed in converting 25th argument `x' of core.subgreen2 to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        x = (float *)(PyArray_DATA(capi_x_tmp));
    ...
    capi_tdata_tmp = array_from_pyobj(NPY_FLOAT,tdata_Dims,tdata_Rank,capi_tdata_intent,tdata_capi);
    if (capi_tdata_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : core_error,"failed in converting 29th argument `tdata' of core.subgreen2 to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        tdata = (float *)(PyArray_DATA(capi_tdata_tmp));
    ...
    if (capi_zz_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : core_error,"failed in converting hidden `zz' of core.subgreen2 to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        zz = (float *)(PyArray_DATA(capi_zz_tmp));
    ...
    if (capi_ee_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : core_error,"failed in converting hidden `ee' of core.subgreen2 to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        ee = (float *)(PyArray_DATA(capi_ee_tmp));
    ...
    if (capi_nn_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : core_error,"failed in converting hidden `nn' of core.subgreen2 to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        nn = (float *)(PyArray_DATA(capi_nn_tmp));
    ...
    if (capi_t0_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : core_error,"failed in converting hidden `t0' of core.subgreen2 to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        t0 = (float *)(PyArray_DATA(capi_t0_tmp));
...
/*end of pyobjfrom*/
        CFUNCSMESS("Building return value.\n");
        capi_buildvalue = Py_BuildValue("NNNN",capi_zz_tmp,capi_ee_tmp,capi_nn_tmp,capi_t0_tmp);
/*closepyobjfrom*/
/*end of closepyobjfrom*/
        } /*if (f2py_success) after callfortranroutine*/
/*cleanupfrompyobj*/
    ...
    /* End of cleaning variable zz */
    if((PyObject *)capi_tdata_tmp!=tdata_capi) {
        Py_XDECREF(capi_tdata_tmp); }
    }  /*if (capi_tdata_tmp == NULL) ... else of tdata*/
    /* End of cleaning variable tdata */
    if((PyObject *)capi_x_tmp!=x_capi) {
        Py_XDECREF(capi_x_tmp); }
...
static FortranDataDef f2py_routine_defs[] = {
    {"subgreen",-1,{{-1}},0,(char *)F_FUNC(subgreen,SUBGREEN),(f2py_init_func)f2py_rout_core_subgreen,doc_f2py_rout_core_subgreen},
    {"subgreen2",-1,{{-1}},0,(char *)F_FUNC(subgreen2,SUBGREEN2),(f2py_init_func)f2py_rout_core_subgreen2,doc_f2py_rout_core_subgreen2},
...
PyMODINIT_FUNC PyInit_core(void) {
    ...
    s = PyUnicode_FromString(
        "This module 'core' is auto-generated with f2py (version:1.23.5).\nFunctions:\n"
"    tdata,zz,ee,nn,t0 = subgreen(mb,src,rcv,stype,updn,d,a,b,rho,qa,qb,dt,nfft,tb,nx,sigma,smth,wc1,wc2,pmin,pmax,dk,kc,taper,x,pf,df,lf,sx,sy,rx,ry)\n"
"    zz,ee,nn,t0 = subgreen2(mb,src,rcv,stype,updn,d,a,b,rho,qa,qb,dt,nfft,tb,nx,sigma,smth,wc1,wc2,pmin,pmax,dk,kc,taper,x,pf,df,lf,tdata,sx,sy,rx,ry)\n"
".");

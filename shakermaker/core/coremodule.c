 ...
 * Generation date: Wed Jan 21 19:00:11 2026
...
/* See f2py2e/rules.py */
extern void F_FUNC(subgreen,SUBGREEN)(int*,int*,int*,int*,int*,float*,float*,float*,float*,float*,float*,float*,int*,int*,int*,float*,int*,int*,int*,float*,float*,float*,float*,float*,float*,float*,float*,float*,float*,complex_float*,float*,float*,float*,float*,float*,float*,float*,float*);
...
tdata,spectrum,zz,ee,nn,t0 = subgreen(mb,src,rcv,stype,updn,d,a,b,rho,qa,qb,dt,nfft,tb,nx,sigma,smth,wc1,wc2,pmin,pmax,dk,kc,taper,x,pf,df,lf,sx,sy,rx,ry)\n\nWrapper for ``subgreen``.\
\n\nParameters\n----------\n"
"mb : input int\n"
"src : input int\n"
"rcv : input int\n"
...
"spectrum : rank-3 array('F') with bounds (nx,9,2 * nfft)\n"
...
static PyObject *f2py_rout_core_subgreen(const PyObject *capi_self,
                           ...
                           void (*f2py_func)(int*,int*,int*,int*,int*,float*,float*,float*,float*,float*,float*,float*,int*,int*,int*,float*,int*,int*,int*,float*,float*,float*,float*,float*,float*,float*,float*,float*,float*,complex_float*,float*,float*,float*,float*,float*,float*,float*,float*)) {
...
/*decl*/
    ...
    complex_float *spectrum = NULL;
    npy_intp spectrum_Dims[3] = {-1, -1, -1};
    const int spectrum_Rank = 3;
    PyArrayObject *capi_spectrum_as_array = NULL;
    int capi_spectrum_intent = 0;
    float sx = 0;
...
/*frompyobj*/
    ...
    /* Processing variable spectrum */
    spectrum_Dims[0]=nx,spectrum_Dims[1]=9,spectrum_Dims[2]=2 * nfft;
    capi_spectrum_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
    const char * capi_errmess = "core.core.subgreen: failed to create array from the hidden `spectrum`";
    capi_spectrum_as_array = ndarray_from_pyobj(  NPY_CFLOAT,1,spectrum_Dims,spectrum_Rank,  capi_spectrum_intent,Py_None,capi_errmess);
    if (capi_spectrum_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = core_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        spectrum = (complex_float *)(PyArray_DATA(capi_spectrum_as_array));
...
#endif
/*callfortranroutine*/
                (*f2py_func)(&mb,&src,&rcv,&stype,&updn,d,a,b,rho,qa,qb,&dt,&nfft,&tb,&nx,&sigma,&smth,&wc1,&wc2,&pmin,&pmax,&dk,&kc,&taper,x,&pf,&df,&lf,tdata,spectrum,&sx,&sy,&rx,&ry,zz,ee,nn,t0);
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
...
/*end of pyobjfrom*/
        ...
        capi_buildvalue = Py_BuildValue("NNNNNN",capi_tdata_as_array,capi_spectrum_as_array,capi_zz_as_array,capi_ee_as_array,capi_nn_as_array,capi_t0_as_array);
/*closepyobjfrom*/
...
/*cleanupfrompyobj*/
    ...
    }  /* if (capi_spectrum_as_array == NULL) ... else of spectrum */
    /* End of cleaning variable spectrum */
